...
const EstimateEdit = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_NEXT_URL}api/estimate/update/${id}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col md:flex-row justify-between items-center md:items-center mb-[19px]">
                <div className="w-full sm:w-auto sm:mr-auto mb-4 sm:mb-0">
                  <div className="text-sm text-gray-700 mb-2 md:mb-0 text-left">
                          ...
                          <div className="bg-white rounded-lg  border p-4">
                            ...
                            <div className="overflow-auto  space-y-3">
                              <textarea
                                ...
                                className="border rounded p-1 text-gray-700 w-full"
                              />
                            </div>
                          </div>
                          ...
                          <div className="bg-white rounded-lg  border p-4">
                            ...
                            <div className="overflow-auto">
                              <textarea
                                ...
                                className="w-full h-full border rounded p-2 text-gray-700 text-[12px]"
...
export default withAuth(EstimateEdit);
