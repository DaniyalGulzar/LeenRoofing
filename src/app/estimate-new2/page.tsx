...
const Estimatedetailnew2 = () => {
  ...
  const handleRecordingComplete = (audioBlob: Blob) => {
    ...
    // Append the audioBlob to the form data with the key 'audio'
    formData.append("audio", audioBlob, "recording.wav"); // 'recording.wav' is the filename

    // Now you can use formData to send the audio via an HTTP request
    // For example, if you're using Axios:

    axios
      .post(`${process.env.NEXT_PUBLIC_NEXT_URL}api/dashboard`, formData, {
        headers: {
    ...
    // Optionally, call addAudioElement if you still want to use it
    ...
    <div className="h-[100vh] overflow-auto bg-gray-100">
      <AuthWrapper title="Welcome Back, Tony">
        <div className="px-[20px] md:px-[48px] pt-[15px] md:pt-[35px] w-full">
              ...
              <div className="flex flex-col justify-center items-center h-[193px] p-3 border">
                <div className="flex items-center">
                  <Image
                    ...
                    height={52}
                    alt="Pause"
                    className="mx-1 min-w-[30px] min-h-[30px]"
                  />
                  <Image
          ...
          <div className="flex flex-col justify-center items-center mt-[20px] mb-[44px] p-4 border rounded-lg  bg-white cursor-pointer">
            ...
            <div className="flex items-center mt-[24px] gap-[13px]">
              <Image
                ...
                height={52}
                alt="Microphone"
                className="min-w-[30px] min-h-[30px] cursor-pointer"
...
export default withAuth(Estimatedetailnew2);
